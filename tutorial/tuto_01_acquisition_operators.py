...
This tutorial shows how to simulate measurements using the :mod:`spyrit.core.meas`
submodule. The simulations are based on three modules:
...
###############################################################################
# We crop the batch to get 15 x 32 image
x = x[:,:,:15,:]
...
###############################################################################
# We instantiate a measurement operator from a 10 x 15*32 random matrix. To indicate that the operator works in 2D, we use the :attr:`meas_shape` argument.
