...
Key concepts:
    - Dynamic forward operator :math:`H_{\text{dyn}}` that accounts for motion during acquisition
...
# %%
# We used the :meth:`DynamicHadamSplit2d` class (Specialized for Hadamard patterns)
...
# -----------------------------------------------------------------------------
#
# Set up regularization for the inverse problem.
# Options:
...
x_dyn_plot = x_dyn.view(*img_shape, n_wav)
...
#   - Built the motion-compensated system matrix H_dyn : with pattern or image warping
