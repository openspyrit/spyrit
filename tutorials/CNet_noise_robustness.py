...
# 50 photons
title_50  = prefix + 'N0_50.0_sig_0.0_' + suffix

# 10 photons
title_10  = prefix + 'N0_10.0_sig_0.0_' + suffix

# 2 photons
title_2  = prefix + 'N0_2.0_sig_0.0_' + suffix
...
for ph_i, ph_v in enumerate(ph):
    ...
    model = noiCompNet(img_size, M, Mean, Cov, N0=ph_v, H=H)
...
#plt.savefig("CNet_noise_robustness.pdf", bbox_inches=0)