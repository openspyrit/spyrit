...
model_title  = 'NET_c0mp_N0_10.0_sig_0.5_N_64_M_1024_epo_40_lr_0.001_sss_10_sdr_0.5_bs_1024_reg_1e-07'
...
axs[1].set_title("C-Net recon")
axs[2].set_title("ground-truth")
axs[3].set_title("C-Net recon")
