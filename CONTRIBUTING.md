...
* Info sur le repo
```
git status      // Etat de la branche courante
git branch -a   // regarder les branches :
```
 * Creation de branche
```
...
```
* delete the useless branch
```
git branch --merged (to check everything is sucessfully merged)
