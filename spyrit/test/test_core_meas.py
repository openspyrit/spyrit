...
def test_core_meas():
    ...
    assert_equal_all(meas_op._param_H_static.data, H_static,
                          "Wrong H_static")
    ...
    assert_equal(meas_op.meas_shape, torch.Size([50, 50]),
                      "Wrong meas_shape")
    ...
    assert_equal_all(meas_op.indices, torch.arange(399, -1, -1),
                          "Wrong indices")
    assert_equal_all(meas_op._param_H_static.data, H_static.flip(0),
                          "Wrong sorting with Ord")
    # Ord setter
    ...
    print("\tget_mat... ", end="")
    H = meas_op.H
    assert_shape(H.shape, torch.Size([400, 2500]),
                      "Wrong measurement matrix size")
    print("ok")
    ...
    assert_shape(meas_op.H_dyn_pinv.shape, torch.Size([2500, 400]),
                 "Wrong H_dyn_pinv size")
    print("ok")
